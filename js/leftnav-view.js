    ...
    function LeftNavView() {
        ...
        */
        this.expand = function () {
            ...
            this.scrollingContainerEle.style.webkitTransform = "translateY(0px)";
        ...
        */
        this.setSelectedElement = function (ele) {
            ...
            if(ele != this.$el.find("#search-input")[0])
        ...
        */
        ...
        this.render = function ($el, catData, startIndex) {
            ...
            mouseevents.registerClickHandler("leftnav-list-item-static", this.handleListItemSelection);
        ...
        */
        this.handleControls = function (e) {
            if (e.type === 'swipe') {
                ...
                if ($(this.leftNavContainerEle).hasClass('leftnav-menulist-expanded') && !$(e.target).hasClass("leftnav-list-item-static")) {
                    this.selectLeftNavItem();
                    this.collapse();
                    this.trigger('deselect');
               }
