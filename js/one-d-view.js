    ...
    function OneDView() {
        ...
        */
        ...
        this.render = function ($el, rowData, displayButtonsParam) {
            ...
            this.createCarouselView(rowData);
        ...
        */
        this.createShovelerView = function (rowData) {
            ...
            shovelerView.on('indexChange', function(index) {
                this.currSelection = index;
                this.carouselView.updateIndex(index);
        ...
        */
        ...
        /**
         * Create carousel controllers that will iterate over shoveler items
        */
      

         this.createCarouselView = function (rowData) {
            this.$carouselContainer = this.$el.children("#one-D-carousel-controls-container");
            var carouselView = this.carouselView = new CarouselView();
            this.carouselView.render(this.$carouselContainer, rowData);
            this.carouselView.updateIndex(this.currSelection);

            carouselView.on('indexChange', function(index) {
