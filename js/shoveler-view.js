...
(function (exports) {
    ...
    function ShovelerView() {
        ...
        Events.call(this, ['loadComplete', 'exit', 'bounce', 'startScroll', 'indexChange', 'stopScroll', 'select', 'bounce', 'click']);
        ...
        this.transformStyle = utils.transformPrefix;
        ...
        */
        ...
        this.render = function (el, row) {
            ...
            mouseevents.registerClickHandler("shoveler-full-img", this.handleContentItemSelection);
