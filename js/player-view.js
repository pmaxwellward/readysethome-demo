...
(function(exports) {
    ...
    function PlayerView(settings) {
        ...
        Events.call(this, ['exit', 'videoStatus', 'indexChange', 'error', 'hover','buttonpress']);
        ...
        this.render = function ($container, data, index) {
            ...
            if (video_data.type === "video-live") {
                ...
                this.controlsView.render(this.$el, video_data, this);
                this.controlsView.on('buttonpress', this.handleControls);
            }
        ...
        this.handleControls = function(e) {
            if (e.type === 'buttonpress') {
                ...
                if (e.target.className == "player-pause-indicator") {
                    if (this.videoElement.paused) {
                        this.resumeVideo();
                    } else {
                        this.pauseVideo();
