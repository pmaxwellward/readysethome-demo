...
(function (exports) {
    ...
    function ControlsView() {
        ...
        Events.call(this, ['loadingComplete', 'hover', 'buttonpress']);
        ...
        */
        ...
        this.render = function ($container, data, playerView) {
            ...
            this.rewindIcon = $container.find(".rewind-button")[0];
            this.forwardIcon = $container.find(".forward-button")[0];            
            ...
            mouseevents.registerHoverHandler(this.containerControls);
